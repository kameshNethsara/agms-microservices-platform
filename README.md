...
* **Central Config Server (Port 8888):** Manages application properties across all environments.
    * 🔗 **Config Repository:** [agms-microservices-config](https://github.com/kameshNethsara/agms-microservices-config.git)
